 ...
 //  ISAR SET INTERVAL PARA VARRER O BANCO DE DADOS 
    ...
    /*
      ...
      //var check_time_cc = setInterval(function(){ cc++;
        ...
        var titulo = "mergulho com tubarão baleia filipinas";
        prompt_ai = "Crie um artigo de qualidade, relevante e descontraido sobre: "+titulo;
        ...
        ////////////////////////// DB
        var url_endpointpost = "https://produtosinovadores.com.br/catalogo/ai/import_ai_para_wp_post"; 
        request.post({
...
var cc = 0;
      var check_time_cc = setInterval(function(){ cc++;
        ...
        var url_endpointpost = "https://produtosinovadores.com.br/catalogo/ai/get_topicos_ai"; 
        request.post({
            url: url_endpointpost,
            form: {
                key: 'value',
