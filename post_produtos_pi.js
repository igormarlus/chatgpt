...
var cc = 0;
      var check_time_cc = setInterval(function(){ cc++;
        ...
        var url_endpointpost = "https://produtosinovadores.com.br/catalogo/ai/get_produtos_pi"; 
        request.post({
                ...
                if (err) {
                    ...
                    for(var h=0; h<obj.length; h++){
                      ...
                      if(h <= obj.length){
                          ...
                          prompt_ai = "Crie um artigo apresentando informações úteis e confiáveis criadas principalmente para beneficiar as pessoas, tendo como assunto principal: "+titulo;
                          ...
                          .then((response) => {
                            ...
                            var url_endpointpost = "https://produtosinovadores.com.br/catalogo/ai/import_ai_para_pi"; // especificacoes_ai
                            request.post({
                                url: url_endpointpost,
                                form: {                
